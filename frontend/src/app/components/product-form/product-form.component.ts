            ...
            <form [formGroup]="productForm" (ngSubmit)="onSubmit()" class="space-y-10">
              ...
              <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <!-- URL da Imagem -->
                  <div class="space-y-4">
                    <label for="imagem_url" class="block text-lg font-semibold text-gray-700 flex items-center">
                ...
                <!-- Preview da Imagem -->
                <div *ngIf="productForm.get('imagem_url')?.value" class="mt-8">
                  <label class="block text-lg font-semibold text-gray-700 mb-4">
                    Preview da Imagem
                  </label>
                  <div class="relative inline-block">
                    <img 
                      [src]="productForm.get('imagem_url')?.value" 
        ...
        this.productService.createProduct(formData).subscribe({
          ...
          error: (error) => {
            ...
            this.messageService.add({
              severity: "error",
              summary: "Erro",
              detail: error.message || "Erro ao criar produto",
              life: 5000,
            })
            this.isSubmitting = false
          },
